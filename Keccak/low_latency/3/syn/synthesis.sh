...
# read verilog file
analyze -format verilog  {../RTL/AND_XOR.v}
analyze -format verilog  {../RTL/keccak_sbox.v}
...
write -format verilog -hierarchy -output ../nl/unflattened/keccak_sbox.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/keccak_sbox.v
