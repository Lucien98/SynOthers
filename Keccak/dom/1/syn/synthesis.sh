...
# read verilog file
analyze -format verilog  {../RTL/keccak_sbox_wo.v}

elaborate keccak_sbox


current_design keccak_sbox
...
set_dont_use [get_lib_cells ${lib_name}/SDFFR*]

compile -map_effort medium -area_effort medium
compile_ultra -no_autoungroup

write -format verilog -hierarchy -output ../nl/unflattened/keccak_sbox_r1.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/keccak_sbox_r1.v
